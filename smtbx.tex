...
We have presented herein the full mathematical derivations of concepts used within Olex2.refine, which form the core of our refinement program accessed from and utilised within Olex2. Hitherto we have employed third party refinement engines and while those options still exist, we will, by default use this new code.[correct?].
It forms part of the open source package, Olex 2 (.version no ) ?  available from the web…***  .
