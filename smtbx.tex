...
\cauthor[a,\dagger]{Luc J.}{Bourhis}{luc\_j\_bourhis@mac.com}{foobar}
\author[b,\dagger]{Oleg V.}{Dolomanov}
\author[c,\dagger]{Richard J.}{Gildea}
\author[d]{Judith A. K.}{Howard}
\author[b,\dagger]{Horst}{Puschmann}

\aff[a]{\brukerfr}
\aff[b]{\olexsys}
\aff[c]{\diamondlight}
\aff[d]{\durhamchem}
\aff[\dagger]{the Dept. of Chemistry of Durham University at the time where the work reported in this article was done}
